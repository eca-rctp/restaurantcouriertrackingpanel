...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_query = "UPDATE Users SET User_Name = ?, User_Surname = ?, User_Email = ?, User_PhoneNumber = ?, User_Password = ? WHERE User_Username = ?";
    $update_stmt = $connection->prepare($update_query);
    $update_stmt->bind_param("ssssss", $name, $surname, $email, $phone, $password, $username);
    $update_stmt->execute();
...
<div class="container mt-5">
    ...
    <form method="POST" action="">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" id="password" name="password" value="<?php echo htmlspecialchars($user['User_Password']); ?>" required>
        </div>
